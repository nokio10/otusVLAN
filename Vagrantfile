...
{ip: '192.168.255.4', adapter: 8, netmask: "255.255.255.252"},
]
},
:testClient2 => {
:box_name => "ubuntu/focal64",
...
:net => [
{adapter: 2, virtualbox__intnet: "local"},
{ip: '192.168.255.6', adapter: 8, netmask: "255.255.255.252"},
]
},
:testServer1 => {
:box_name => "ubuntu/focal64",
...
:net => [
{adapter: 2, virtualbox__intnet: "local"},
{ip: '192.168.255.8', adapter: 8, netmask: "255.255.255.252"},
]
},
:testServer2 => {
:box_name => "ubuntu/focal64",
...
:net => [
{adapter: 2, virtualbox__intnet: "local"},
{ip: '192.168.255.10', adapter: 8, netmask: "255.255.255.252"},
]
}
}
